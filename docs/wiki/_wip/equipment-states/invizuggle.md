...
- Without some other way to uncull them, invizuggles are permanent attachments, and can't be removed except by closing the game.
- New fusions to shields and weapons don't fuse entangle to invizuggles.
- Any method to uncull the invizuggle will revert it to a completely standard zuggle.
