...
| Index | Base Actor ID<br/?Base Actor Name | Base Actor Name | Replacement Actor ID | Replacement Actor Name | Self-replacing? | Defuse returns Replacement? | Additional Info |
| --- | --- | --- | --- | --- | --- | --- | --- |
|  | AsbObj_Icicle_A_01 | Icicle | AsbObj_Icicle_A_01 | Icicle | ✔️ | ❌ |   |
|  | AsbObj_Icicle_A_02 | Icicle | AsbObj_Icicle_A_01 | Icicle | ❌ | ❌ | Large Icicle |
|  | AsbObj_WoodSail_A_01 | Tattered Sail | AsbObj_WoodSail_A_01_ForAttachment | Tattered Sail (Replacement) | ❌ | ✔️ | Replacement does not pivot |
|  | AsbObj_WoodSail_A_02 | Pristine Sail | AsbObj_WoodSail_A_02_ForAttachment | Pristine Sail (Replacement) | ❌ | ✔️ | Replacement Does not pivot |
|  | BombFruit | Bomb Flower | BombFruit | Bomb Flower | ✔️ | ❌ |   |
|  | BrokenSnowBall | Snowball | BrokenSnowBallForAttachmentSmall | Snowball (Replacement) - Small | If scale <1.25 when fused |
|  | BrokenSnowBall | Snowball | BrokenSnowBallForAttachmentLarge | Snowball (Replacement) - Large | If scale ≥1.25 when fused |
|  | BrokenSnowBallForAttachmentSmall<br/>Small Fused Snowball | BrokenSnowBallForAttachmentSmall<br/>(If scale <1.25 when fused)<br/>BrokenSnowballForAttachmentLarge<br/>(If scale ≥1.25 when fused)|
|  | BrokenSnowBallForAttachmentLarge | Large Fused Snowball |
|  | BrokenSnowBallForDrake | Gleeok Snowball | BrokenSnowBallForAttachmentSmall | Snowball (Replacement) - Small | If scale <1.25 when fused |
|  | BrokenSnowBallForDrake | Gleeok Snowball | BrokenSnowBallForAttachmentLarge | Snowball (Replacement) - Small | If scale ≥1.25 when fused |
...
same thing but i politely divided the table into categories (which have some overlap)
