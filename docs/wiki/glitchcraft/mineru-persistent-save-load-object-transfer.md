...
aliases: ["mineru-persistent-save-load-object-transfer"]
...
3. Map Invizuggle it.
4. Cull/uncull Mineru to uncull the invizuggle, don't detangle it.
5. YeeFE your target to a shield B, this will FE to both shield A and B.
6. Portacull Invismuggle shield B.
7. Fuse a rocket to a shield
8. Rezuggle shield A by invizuggling it and cull/unculling Mineru.
