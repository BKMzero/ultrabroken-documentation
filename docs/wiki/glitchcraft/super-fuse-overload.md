...
16. Glue E to something in the Rasitakiwak shrine, smuggle C, regularly equip B, and then overload pick up E
...
18. Repeat step 6 until shields are no longer ghosted the second time you fuse them
...
5. Go over to miner and spam A until you pick up her arm
6. Undock your switch
7. Fuse a cart to mineru's arm
8. Make a portacull and SRZ mineru's arm
9. Load Rasitakiwak shrine
...
4. Throw aim a weapon
5. Select a zonai device to throw
6. Pick it up as it falls
7. Swap to another zonai device you want to dupe
